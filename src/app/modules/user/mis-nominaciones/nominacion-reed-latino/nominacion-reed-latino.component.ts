...
@Component({
  selector: 'app-nominacion-reed-latino',
  templateUrl: './nominacion-reed-latino.component.html',
  styleUrls: ['./nominacion-reed-latino.component.css']
})
export class NominacionReedLatinoComponent implements OnInit {
  fetchNominacion(){
    this.accion = '';
  ...
  defaultCategoria:CategoriaModel = new CategoriaModel();
  constructor(
  ...
  getCategorias(){
    this.categoriasService.getCategorias().subscribe( (data) => {
      if(data.length > 0){
        ...
        this.defaultCategoria = this.categorias[0]
        console.log(this.categorias[0])
        this.nominacionForm.value['categoria'] = this.categorias[0]
  ...
  saveDataNominacion(){
      ...
      if(imgError.length && imgError.length > 0){
        ...
        const dataNominacion: NominacionModel = {
          ...
          categoria: this.defaultCategoria.nombre,
